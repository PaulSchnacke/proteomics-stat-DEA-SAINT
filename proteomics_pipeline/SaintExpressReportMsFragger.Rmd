...
bb <- crosstalk::SharedData$new(as.data.frame(bb), ~Prey, group = "Choose_protein")
...
xd <- prolfqua::volcano_plotly( 
  ...
  title_size = 10, group = "Choose_protein")
...
sig <- crosstalk::SharedData$new(as.data.frame(SEP$sig), ~Prey, group = "Choose_protein")
DT::datatable(sig)
```
